    ...
    <swiper>
      <swiper-slide>
        ...
        <div>
          ...
          <!--第二部分内容-->
          <!--卡片组件-->
          <m-card plain icon='iconfont icon-zhuangbei' title='出装推荐' class='hero-items'>
          ...
          <m-card plain icon='iconfont icon-icon' title='使用技巧'>
              <p class='m-0'>{{model.usageTips}}</p>
          </m-card>
          <m-card plain icon='iconfont icon-duikang-VS' title='对抗技巧'>
              <p class='m-0'>{{model.battleTips}}</p>
          </m-card>
          <m-card plain icon='iconfont icon-tuanduizonglan' title='团战思路'>
            <p class='m-0'>{{model.teamTips}}</p>
          </m-card>
          <m-card plain icon='iconfont icon-tuandui' title='英雄关系'>
