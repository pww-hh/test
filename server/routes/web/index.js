...
module.exports=app=>{
    ...
    router.get('/news/init',async(req,res)=>{
        ...
        const newsTitles=['吕布特效升级过程沟通&;赵云百木心枪优化【老亚瑟的答疑时间】', '蔡小姬探班手记：公孙离玉兔公主皮肤海报设计故事', '对决快手天赐西游小队，赢荣耀水晶', '元歌源梦皮肤设计大赛最终投票开启公告', '狄某有话说 | 对抗路是我家，打团支援我不理他', '3月30日外挂专项打击公告', '3月30日“演员”惩罚名单', '3月30日游戏内违规签名、攻略信息处罚公告', '3月30日挂车行为专项违规处罚公告', '3月29日体验服停机更新公告', '【QQ福利】超前购买“孙悟空-零号·赤焰”皮肤活动', '【微信用户专属】微信小程序“游戏礼品站”抢先购买孙悟空-零号·赤焰', '元歌皮肤设计大赛最终投票结果公示', '元歌源梦皮肤设计大赛最终投票开启公告', '元歌未来幻想皮肤设计大赛优秀创意奖、人气创意奖公布', '今日预报丨“浴室”大战再演，北京WB战广州TTG谁能取胜？', '今日预报丨南京Hero对决济南RW侠，佛山GK能否重回S组', 'KPL今日预报丨第二轮收官，成都AG、北京WB谁能进入卡位赛', '今日预报丨佛山GK冲击五连胜，杭州LGD大鹅挑战武汉ES', 'KPL今日预报丨敢梦敢刚，西安WE能否终结重庆狼队九连胜？']
        //把数据放入模型
    ...
    router.get('/news/list',async(req,res)=>{
        ...
        //查找文章的父级分类是新闻分类的文章
        //cast是category模型的基础上增加newsList(内容为articles中的categories)
        const cats=await Category.aggregate([
            //删选除父级为新闻分类的category
            {$match:{parent:parent._id}},
            //category和article两个模型中
            {
                $lookup:{
                    from:'articles',
                    //category的_id
